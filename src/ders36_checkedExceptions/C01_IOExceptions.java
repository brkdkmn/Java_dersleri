...
public class C01_IOExceptions {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        // FileInputStreamolustururken ulasmak istedigimiz dosyanin
        // dosya yolunu parametre olarak girmeliyiz

        /*
          Checked exceptions olusturma ihtimali olan kodlari yazdigimizda
          java compile time orada bir hata ihtimali oldugunu gorur ve
